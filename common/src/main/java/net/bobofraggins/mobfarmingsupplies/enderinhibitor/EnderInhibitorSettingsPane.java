...
/**
 * Dialog pane that renders the "Suppression Zone:" header and X/Y/Z axis labels for the
 * Ender Inhibitor's offset controls.
 *
 * <p>The actual ± buttons are added as vanilla {@link net.minecraft.client.gui.components.Button}
 * widgets in {@link EnderInhibitorScreen#init()}.
 */
public class EnderInhibitorSettingsPane implements IDialogPane {

    public static final int WIDTH  = 181;
    public static final int HEIGHT = 34;

    /** Y of the axis letters (pane-local), below the "Suppression Zone:" header. */
    ...
    public void render(
        ...
        g.text(font, Component.literal("Suppression Zone:"), 8, 4, TEXT_COLOR, false);
