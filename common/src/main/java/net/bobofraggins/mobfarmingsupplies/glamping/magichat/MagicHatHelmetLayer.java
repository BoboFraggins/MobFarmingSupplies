...
/**
 * Renders the Magic Hat's own 3D item model on the wearer's head, in place of the flatter
 * vanilla equipment-texture layer — used whenever the hat is worn in the vanilla head slot.
 */
